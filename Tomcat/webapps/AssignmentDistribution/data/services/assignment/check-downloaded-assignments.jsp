...
try
{
String sql = "select * from assignment_download_view where `batch_id` = ?  and `branch_id`= ?  and semester_no = ? and subject_id = ? and module_id = ? and section = ? and (group_by =  '3' or group_by = ?) and assignment_id = ?";
